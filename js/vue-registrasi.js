    ...
    <div class="reg-card" style="width:100%; max-width:720px; background:var(--surface); border:1px solid var(--line); border-radius:22px; padding:34px; margin:20px auto;" v-else>
      ...
      <div style="font-size:13px;">
        ...
        <div style="margin-bottom:22px;">
          ...
          <div style="display:grid; gap:14px; padding-top:12px; border-top:1px solid var(--line); margin-top:8px;" class="grid-cols-1 md:grid-cols-2">
        ...
        <div style="margin-bottom:22px;">
          ...
          <div style="display:grid; gap:12px; margin-bottom:14px;" class="grid-cols-1 md:grid-cols-3">
          ...
          <div style="background:var(--ivory-dim); border-radius:14px; padding:14px; margin-bottom:12px;">
            ...
            <div style="display:grid; gap:10px; margin-top:10px;" class="grid-cols-1 md:grid-cols-2">
        ...
        <div style="margin-bottom:22px;">
          ...
          <div style="display:grid; gap:14px; margin-bottom:12px;" class="grid-cols-1 md:grid-cols-2">
          ...
          <div style="display:grid; gap:12px;" class="grid-cols-1 md:grid-cols-3">
