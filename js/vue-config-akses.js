...
const DAFTAR_MENU = [
  ...
  { id: 'report_absensi', label: 'Report Absensi', kategori: 'Master Absensi', icon: 'fa-chart-pie',
    aksi: () => { window.pindahTab('tab-admin-acc'); window.pindahSubTab('sub-absensi', 'sub-absensi-report', null, {catatRiwayat:true}); } },
