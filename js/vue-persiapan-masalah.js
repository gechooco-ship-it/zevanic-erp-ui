...
// ambilDaftarBahanAksesorisLengkap — combined Bahan+Aksesoris, dipakai di sini
// DAN di vue-stock-pembelian.js (disalin, bukan diimpor silang, supaya 2 file
// ini tetap bisa berdiri sendiri-sendiri kalau salah satu diedit).
...
const PersiapanMasalahManager = {
  ...
  setup() {
    ...
    // Isi otomatis Satuan begitu Nama dipilih (dari satuan_pemakaian item), tapi
    // tetap boleh diubah manual kalau perlu.
